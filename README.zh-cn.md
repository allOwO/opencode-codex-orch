...
> 加入我们！
>
> | [<img alt="Discord link" src="https://img.shields.io/discord/1452487457085063218?color=5865F2&label=discord&labelColor=black&logo=discord&logoColor=white&style=flat-square" width="156px" />](https://discord.gg/PUwSMR9XNk) | 加入我们的 [Discord 社区](https://discord.gg/PUwSMR9XNk)，与贡献者及其他 `opencode-codex-orch` 用户交流。 |
> | :-----| :----- |
> | [<img alt="X link" src="https://img.shields.io/badge/Follow-%40justsisyphus-00CED1?style=flat-square&logo=x&labelColor=black" width="156px" />](https://x.com/justsisyphus) | 关于 `opencode-codex-orch` 的新闻和更新过去发布在我的 X 账号上。<br /> 因为账号被意外停用，现在由 [@justsisyphus](https://x.com/justsisyphus) 代为发布更新。 |
...
[![opencode-codex-orch](./.github/assets/hero.jpg)](https://github.com/allOwO/opencode-codex-orch#opencode-codex-orch)

[![Preview](./.github/assets/oco.png)](https://github.com/allOwO/opencode-codex-orch#opencode-codex-orch)
...
[![GitHub Release](https://img.shields.io/github/v/release/allOwO/opencode-codex-orch?color=369eff&labelColor=black&logo=github&style=flat-square)](https://github.com/allOwO/opencode-codex-orch/releases)
[![npm downloads](https://img.shields.io/npm/dt/opencode-codex-orch?color=ff6b35&labelColor=black&style=flat-square)](https://www.npmjs.com/package/opencode-codex-orch)
[![GitHub Contributors](https://img.shields.io/github/contributors/allOwO/opencode-codex-orch?color=c4f042&labelColor=black&style=flat-square)](https://github.com/allOwO/opencode-codex-orch/graphs/contributors)
[![GitHub Forks](https://img.shields.io/github/forks/allOwO/opencode-codex-orch?color=8ae8ff&labelColor=black&style=flat-square)](https://github.com/allOwO/opencode-codex-orch/network/members)
[![GitHub Stars](https://img.shields.io/github/stars/allOwO/opencode-codex-orch?color=ffcb47&labelColor=black&style=flat-square)](https://github.com/allOwO/opencode-codex-orch/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/allOwO/opencode-codex-orch?color=ff80eb&labelColor=black&style=flat-square)](https://github.com/allOwO/opencode-codex-orch/issues)
[![License](https://img.shields.io/badge/license-SUL--1.0-white?labelColor=black&style=flat-square)](https://github.com/allOwO/opencode-codex-orch/blob/dev/LICENSE.md)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/allOwO/opencode-codex-orch)
...
> “用 opencode-codex-orch 吧，你绝对回不去了。” <br/>- [d0t3ch](https://x.com/d0t3ch/status/2001685618200580503)
...
> “opencode-codex-orch 简直疯了。” - [YouTube - Darren Builds AI](https://www.youtube.com/watch?v=G_Snfh2M41M)
...
```bash
curl -s https://raw.githubusercontent.com/allOwO/opencode-codex-orch/main/docs/guide/installation.md
```
...
```
Read this and tell me why it's not just another boilerplate: https://raw.githubusercontent.com/allOwO/opencode-codex-orch/main/README.md
```
...
> **第一次用 opencode-codex-orch？** 阅读 **[概述](docs/guide/overview.md)** 了解你拥有哪些功能，或查看 **[编排指南](docs/guide/orchestration.md)** 了解 Agent 如何协作。

## 如何卸载 (Uninstallation)

要移除 opencode-codex-orch:

1. **从你的 OpenCode 配置文件中去掉插件**

   编辑 `~/.config/opencode/opencode.json` (或 `opencode.jsonc`) ，并把 `"opencode-codex-orch"` 从 `plugin` 数组中删掉：

   ```bash
   # 如果你有 jq 的话
   jq '.plugin = [.plugin[] | select(. != "opencode-codex-orch")]' \
...
2. **清除配置文件 (可选)**
   ...
   ```bash
   # 移除全局用户配置
rm -f ~/.config/opencode/opencode-codex-orch.json

   # 移除当前项目的配置
rm -f .opencode/opencode-codex-orch.json
   ```
