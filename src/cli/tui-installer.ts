...
export async function runTuiInstaller(args: InstallArgs, version: string): Promise<number> {
  ...
  p.intro(color.bgMagenta(color.white(isUpdate ? " OCO Update " : " oco... ")))
  ...
  spinner.start("Adding opencode-codex-orch to OpenCode config")
  ...
  spinner.start("Writing opencode-codex-orch configuration")
  ...
  p.note(
    `Start with a direct request to the orchestrator.\n` +
