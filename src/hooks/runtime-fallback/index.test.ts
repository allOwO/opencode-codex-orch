...
import type { RuntimeFallbackConfig, OpenCodeCodexOrchConfig } from "../../config"
...
describe("runtime-fallback", () => {
  ...
  function createMockPluginConfigWithCategoryFallback(fallbackModels: string[]): OpenCodeCodexOrchConfig {
    return {
      categories: {
        test: {
  ...
  describe("fallback models configuration", () => {
    function createMockPluginConfigWithAgentFallback(agentName: string, fallbackModels: string[]): OpenCodeCodexOrchConfig {
      return {
        agents: {
          [agentName]: {
            fallback_models: fallbackModels,
