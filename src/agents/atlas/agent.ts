...
export type AtlasPromptSource = "default" | "gpt" | "gemini" | "kimi"
...
export function createAtlasAgent(ctx: OrchestratorContext): AgentConfig {
  const baseConfig = {
    description:
      "Orchestrates work via task() to complete ALL tasks in a todo list until fully done. (Atlas - opencode-codex-orch)",
    mode: MODE,
