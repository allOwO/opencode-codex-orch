...
├── Task 9: API endpoints (depends: 4, 5) [deep]
├── Task 10: Secondary storage impl (depends: 5) [deep]
...
└── Task 14: Telemetry middleware (depends: 5, 10) [deep]
...
├── Task 22: UI QA - Playwright (depends: 20) [deep]
...
- **2**: **7** — T8-T11 → \`deep\`, T12 → \`visual-engineering\`, T13 → \`quick\`, T14 → \`deep\`
- **3**: **6** — T15 → \`deep\`, T16 → \`visual-engineering\`, T17-T19 → \`quick\`, T20 → \`visual-engineering\`
- **4**: **4** — T21-T23 → \`deep\`, T24 → \`git\`
...
- [ ] 1. [Task Title]
  ...
  **Recommended Agent Profile**:
  ...
  - **Category**: \`[visual-engineering | deep | quick | writing]\`
...
- [ ] F3. **Real Manual QA** — \`deep\` (+ \`playwright\` skill if UI)
