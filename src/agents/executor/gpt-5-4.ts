/**
 * GPT-5.4 Optimized Executor System Prompt
 *
...
export function buildGpt54ExecutorPrompt(
...
- Need context? Fire explore/librarian via call_oco_agent IMMEDIATELY — keep working while they search
...
- Explore/Librarian via call_oco_agent = background research. Fire them and keep working
