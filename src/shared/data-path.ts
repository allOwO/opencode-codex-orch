...
const OCO_CACHE_DIRNAME = "opencode-codex-orch"
...
/**
 * Returns the opencode-codex-orch cache directory.
 * All platforms: ~/.cache/opencode-codex-orch
 */
export function getOcoOpenCodeCacheDir(): string {
  return path.join(getCacheDir(), OCO_CACHE_DIRNAME)
}
