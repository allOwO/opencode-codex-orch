...
export async function resumeTask(
  ...
  client.session.promptAsync({
    ...
    body: {
      ...
      ...(task.model?.top_p !== undefined ? { top_p: task.model.top_p } : {}),
      ...(task.model?.maxTokens !== undefined ? { maxTokens: task.model.maxTokens } : {}),
      ...(task.model?.thinking !== undefined ? { thinking: task.model.thinking } : {}),
      ...(task.model?.reasoningEffort !== undefined ? { reasoningEffort: task.model.reasoningEffort } : {}),
      ...(task.model?.textVerbosity !== undefined ? { textVerbosity: task.model.textVerbosity } : {}),
      tools: {
        task: false,
        call_oco_agent: true,
        question: false,
