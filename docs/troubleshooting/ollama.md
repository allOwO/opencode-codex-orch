...
When using Ollama as a provider with opencode-codex-orch agents, you may encounter:
...
- **opencode-codex-orch**: Passes through the SDK's behavior (can't fix at this layer)
...
**Tracking**: https://github.com/allOwO/opencode-codex-orch/issues/1124
...
- **opencode-codex-orch**: https://github.com/allOwO/opencode-codex-orch/issues/1124
